...
<head>
  ...
  <title>MyGalon @yield("title")</title>
...
<body>
    ...
    <nav class="navbar navbar-expand p-0">
     <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="index.html"> MyGalon </a>
    ...
    <div style="min-height: 100%" class="flex-row d-flex align-items-stretch m-0">
        <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
            ...
            <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
              ...
              <li><a href="{{route('brands.index')}}"><span class="oi oi-tag"></span> Manage brands</a></li>
              <li><a href="{{route('stuffs.index')}}"><span class="oi oi-tag"></span> Manage stuffs</a></li>  
